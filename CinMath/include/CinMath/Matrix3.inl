...
namespace CinMath {
	[[nodiscard]] CIN_MATH_INLINE Matrix<3, 3, float> CIN_MATH_CALL operator+(const Matrix<3, 3, float>& matrix) noexcept
	{
		return matrix;
	}
	...
	CIN_MATH_INLINE void CIN_MATH_CALL operator+=(Matrix<3, 3, float>& lhs, const Matrix<3, 3, float>& rhs) noexcept
	{
		lhs.raw[0] += rhs.raw[0];
		lhs.raw[1] += rhs.raw[1];
		lhs.raw[2] += rhs.raw[2];
	...
	CIN_MATH_INLINE void CIN_MATH_CALL operator+=(Matrix<3, 3, float>& lhs, const float rhs) noexcept
	{
		lhs.raw[0] += rhs;
		lhs.raw[1] += rhs;
		lhs.raw[2] += rhs;
	...
	[[nodiscard]] CIN_MATH_INLINE Matrix<3, 3, float> CIN_MATH_CALL operator+(const Matrix<3, 3, float>& lhs, const Matrix<3, 3, float>& rhs) noexcept
	{
		Matrix<3, 3, float> result;
	...
	[[nodiscard]] CIN_MATH_INLINE Matrix<3, 3, float> CIN_MATH_CALL operator+(const Matrix<3, 3, float>& lhs, const float rhs) noexcept
	{
		Matrix<3, 3, float> result;
	...
	[[nodiscard]] CIN_MATH_INLINE Matrix<3, 3, double> CIN_MATH_CALL operator+(const Matrix<3, 3, double>& matrix) noexcept
	{
		return matrix;
	}
	...
	CIN_MATH_INLINE void CIN_MATH_CALL operator+=(Matrix<3, 3, double>& lhs, const Matrix<3, 3, double>& rhs) noexcept
	{
		lhs.raw[0] += rhs.raw[0];
		lhs.raw[1] += rhs.raw[1];
		lhs.raw[2] += rhs.raw[2];
	...
	CIN_MATH_INLINE void CIN_MATH_CALL operator+=(Matrix<3, 3, double>& lhs, const double rhs) noexcept
	{
		lhs.raw[0] += rhs;
		lhs.raw[1] += rhs;
		lhs.raw[2] += rhs;
	...
	[[nodiscard]] CIN_MATH_INLINE Matrix<3, 3, double> CIN_MATH_CALL operator+(const Matrix<3, 3, double>& lhs, const Matrix<3, 3, double>& rhs) noexcept
	{
		Matrix<3, 3, double> result;
	...
	[[nodiscard]] CIN_MATH_INLINE Matrix<3, 3, double> CIN_MATH_CALL operator+(const Matrix<3, 3, double>& lhs, const double rhs) noexcept
	{
		Matrix<3, 3, double> result;
